...
\put(350,-530){\dashbox{10}(950,620)[tr] {\small 输入~}}
...
\put(350,-980){\dashbox{10}(950,420)[tl] {\small ~传播}}
...
\put(\wbc,-1630){\dashbox{10}(600,530)[tr] {\small 源项~}}
...
\put(\wa,-1630){\dashbox{10}(600,530)[tl] {\small ~输出}}
...
\caption{波浪模式例程的子程序结构，不包括服务例程、管理数据结构的例程和
         {\F mpi} 例程。``{\ldots}'' 表示附加源项例程。}
\label{fig:w3wave}
